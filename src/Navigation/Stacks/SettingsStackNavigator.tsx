...
import {NetworkInfoSettings} from '#src/Screens/Settings/Developer/NetworkInfoSettings.tsx';
import {ServerConnectionSettingsScreen} from '#src/Screens/Settings/Notifications/ServerConnectionSettingsScreen.tsx';
import {SettingsScreen} from '#src/Screens/Settings/SettingsScreen.tsx';
import {TestNotificationScreen} from '#src/Screens/Settings/Developer/TestNotificationScreen.tsx';
import {TestErrorScreen} from '#src/Screens/Settings/Developer/TestErrorScreen.tsx';
import {useNavigation} from '@react-navigation/native';
import {useStyles} from '#src/Context/Contexts/StyleContext.ts';
import {SocketSettingsScreen} from '#src/Screens/Settings/SocketSettingsScreen.tsx';
import {PushNotificationSettingsScreen} from '#src/Screens/Settings/Notifications/PushNotificationSettingsScreen.tsx';
import {OobeSettingsScreen} from '#src/Screens/Settings/Developer/OobeSettingsScreen.tsx';
import {ChangeUsernameScreen} from '#src/Screens/Settings/Account/ChangeUsernameScreen.tsx';
import {ChangePasswordScreen} from '#src/Screens/Settings/Account/ChangePasswordScreen.tsx';
import {AccountManagementScreen} from '#src/Screens/Settings/Account/AccountManagementScreen.tsx';
import {LoginScreen} from '#src/Screens/Settings/Account/LoginScreen.tsx';
import {EventSettingsScreen} from '#src/Screens/Event/EventSettingsScreen.tsx';
import {LfgSettingsScreen} from '#src/Screens/LFG/LfgSettingsScreen.tsx';
import {FeatureSettingsScreen} from '#src/Screens/Settings/Developer/FeatureSettingsScreen.tsx';
import {NotificationPollerSettingsScreen} from '#src/Screens/Settings/Notifications/NotificationPollerSettingsScreen.tsx';
import {LoadingSettingScreen} from '#src/Screens/Settings/Developer/LoadingSettingScreen.tsx';
import {RegisterScreen} from '#src/Screens/Settings/Account/RegisterScreen.tsx';
import {CruiseSettingsScreen} from '#src/Screens/Settings/Developer/CruiseSettingsScreen.tsx';
import {UserInfoSettingsScreen} from '#src/Screens/Settings/Developer/UserInfoSettingsScreen.tsx';
import {AboutSettingsScreen} from '#src/Screens/Settings/AboutSettingsScreen.tsx';
import {QuerySettingsScreen} from '#src/Screens/Settings/Developer/QuerySettingsScreen.tsx';
import {CommonStackParamList} from '#src/Navigation/CommonScreens.tsx';
import {QueryKeysSettingsScreen} from '#src/Screens/Settings/Developer/QueryKeysSettingsScreen.tsx';
import {QueryDataSettingsScreen} from '#src/Screens/Settings/Developer/QueryDataSettingsScreen.tsx';
import {TimeSettingsScreen} from '#src/Screens/Settings/Config/TimeSettingsScreen.tsx';
