 ...
 * boundaries, and per-item colors. All consumers are React components/screens.
 */
export const useDayPlanner = () => {
   ...
   */
  const getMinutesFromDayStartForNow = (timeZoneID: string, dayStart: Date, now: Date): number | null => {
