    ...
    <AppView>
      <ScrollingContentView isStack={true} overScroll={true}>
        <HelpChapterTitleView title={'General'}>
          ...
          <HelpTopicView>
            You can send text, unicode emojis, and our custom emojis. Private event chats can attach one photo per
            message. Seamail and LFG chats cannot include pictures.
          </HelpTopicView>
          <HelpTopicView title={'Insert'} icon={AppIcons.insert}>
            Open the insert menu to add emoji to your post. In a private event chat you can also attach one photo. Press
