...
/**
 * Comes from https://docs.twitarr.com/privacy.html
 */
...
To request account deletion, contact the administrator of your Twitarr server. If this is on JoCo Cruise you can email The Home Office at info@jococruise.com. They will process your request within a reasonable timeframe, subject to applicable requirements.
...
If you have any questions or concerns about this Privacy Policy, please contact us by opening an Issue at [https://github.com/jocosocial/swiftarr/issues](https://github.com/jocosocial/swiftarr/issues).`;

const tricordarrPrivacyPolicyText = `
  ...
  return (
    <AppView>
      <ScrollingContentView isStack={true}>
        <ListSection>
          <ListSubheader>Twitarr Service Policy</ListSubheader>
        </ListSection>
        <PaddedContentView>
          <ContentText text={privacyPolicyText} forceMarkdown={true} />
        </PaddedContentView>
        <ListSection>
          <ListSubheader>Tricordarr Policy Addendum</ListSubheader>
        </ListSection>
        <PaddedContentView>
          <ContentText text={tricordarrPrivacyPolicyText} forceMarkdown={true} />
        </PaddedContentView>
