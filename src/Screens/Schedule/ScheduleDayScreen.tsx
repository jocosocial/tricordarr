...
import {ScheduleHeaderView} from '#src/Views/Schedule/ScheduleHeaderView.tsx';
import React, {useCallback, useEffect, useRef, useState} from 'react';
import {useCruise} from '#src/Context/Contexts/CruiseContext.ts';
import {NativeStackScreenProps} from '@react-navigation/native-stack';
import {ScheduleFAB} from '#src/Buttons/FloatingActionButtons/ScheduleFAB.tsx';
import {RefreshControl, View} from 'react-native';
import {HeaderButtons, Item} from 'react-navigation-header-buttons';
import {MaterialHeaderButton} from '#src/Buttons/MaterialHeaderButton.tsx';
import {ScheduleEventFilterMenu} from '#src/Menus/Schedule/ScheduleEventFilterMenu.tsx';
import {ScheduleDayScreenActionsMenu} from '#src/Menus/Schedule/ScheduleDayScreenActionsMenu.tsx';
import {useAuth} from '#src/Context/Contexts/AuthContext.ts';
import {NotLoggedInView} from '#src/Views/Static/NotLoggedInView.tsx';
import {useEventsQuery} from '#src/Queries/Events/EventQueries.ts';
import {useLfgListQuery, usePersonalEventsQuery} from '#src/Queries/Fez/FezQueries.ts';
...
import {HeaderScheduleYourDayButton} from '#src/Buttons/HeaderButtons/HeaderScheduleYourDayButton.tsx';
import {ScheduleFlatList} from '#src/Lists/Schedule/ScheduleFlatList.tsx';
