...
export const ForumPostActionsDeleteItem = ({forumPost, closeMenu}: ForumPostActionsDeleteItemProps) => {
  ...
  const onPress = () => {
    closeMenu();
    setModalContent(<ForumPostDeleteModalView postData={forumPost} />);
