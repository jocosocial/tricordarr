        ...
        {performerData?.header.id ? (
          <>
            ...
            <PaddedContentView padTop={true}>
              {alreadyAttached ? (
                <Text>
                  Your profile is already attached to this event. Removing it will disassociate your performer profile
                  from the event.
                </Text>
              ) : (
