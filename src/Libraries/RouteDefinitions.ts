...
export const allRoutes: RouteDefinition[] = [
  ...
  {screen: CommonStackComponents.moderateForumScreen, path: 'moderate/forum/:id'},
  ...
  {screen: CommonStackComponents.moderatePersonalEventScreen, path: 'moderate/personalevent/:id'},
...
export const pushableRoutes: RouteDefinition[] = allRoutes.filter(route =>
  [
    ...
    CommonStackComponents.moderateForumScreen,
    ...
    CommonStackComponents.moderatePersonalEventScreen,
